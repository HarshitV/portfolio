...
const TopNavDesktop: NextPage = () => {
    const handleClick = (e: MouseEvent<HTMLAnchorElement, globalThis.MouseEvent>, path: string) => {
        e.preventDefault();
...
const A = styled.a`
    width: 90%;
    font: normal normal normal 22px/1.41em cormorantgaramond-light, cormorantgaramond,
