        ...
        crowdsourcing.'
          ...
          main reasons behind this decreasing popularity are: -'
                ...
                <ContentContainer>
                    ...
                    <VideoContainer>
                        <video src='/buskaro/ideation.mp4' autoPlay muted loop preload='none' />
                    </VideoContainer>
                    <TextContainer>
                        <Text
                            text={
                        ...
                        <OrderedList>
                            ...
                            <li>
                                Building our own <b>hardware device</b> for tracking the location of
                                buses.
                            </li>
                            <li>
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    ...
                                    website awwwards.com for award-winning interfaces. We also used
                                    the material design tool (
                                    <a rel='noreferrer' href='https://material.io' target='_blank'>
                                        material.io
                                    </a>
                        ...
                        <Text bold fontSize='15px' text='Primary Color: Turquoise (#00535B)' />
                        <Text bold fontSize='15px' text='Secondary Color: Red-Orange (#C1403D)' />
                    </TextContainer>
