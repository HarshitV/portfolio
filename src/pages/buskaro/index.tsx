    ...
    return (
        ...
        crowdsourcing."
          ...
          main reasons behind this decreasing popularity are: -"
                        ...
                        <UnorderedList>
                            <li>
                                <b>Unreliable timings</b> of buses due to
                                congestion and traffic jams
                            </li>
                            <li>
                                Unavailability of <b>real-time</b> bus transit
                                data{" "}
                            </li>
                            <li>
                                Difficulty in onboarding new users due to
                                unavailability of updated{" "}
                                <b>routes & schedules</b>
                            </li>
                        </UnorderedList>
                    </TextContainer>
                </ContentContainer>
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    We <b>surveyed</b> almost 50 people to
                                    establish the validity of the problem. Bus
                                    travelers felt that the long waiting times
                    ...
                    <TextContainer>
                        <Text
                            text={
                                <span>
                                    We conducted a <b>contextual inquiry</b> to
                                    investigate this problem further. We found
                                    that most people either know the bus numbers
                                    by experience or find them out by asking
                                    people at the bus stop. Some people also
                                    complained about the inaccuracy of the
                                    scheduled timings in apps like Google Maps.
                                    Buses in a particular route are infrequent,
                                    so the waiting time for travelers sometimes
                                    stretch up to 30 minutes.
                                </span>
                            }
                        />
                    </TextContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    To make sense of the information received,
                                    we built an <b>Affinity Diagram</b> to
                    ...
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    We then listed down the most useful{" "}
                                    <b>insights</b> obtained from the contextual
                                    inquiry: -
                                </span>
                            }
                        />
                ...
                <ContentContainer>
                    ...
                    <TextContainer>
                        <Text
                            text={
                                <span>
                                    ...
                                    <b>brainstorming</b> thoroughly, we used{" "}
                                    <b>convergent thinking</b> to narrow down to
                                    3 ideas that we could possibly focus on: -
                                </span>
                            }
                        />
                        <OrderedList>
                            <li>
                                Using <b>pre-installed GPS devices</b> in DTC
                                buses.
                            </li>
                            <li>
                                Building our own <b>hardware device</b> for
                                tracking the location of buses.
                            </li>
                            <li>
                                <b>Crowdsourcing</b> bus transit data to get a
                                real-time ETA.
                            </li>
                        </OrderedList>
                        ...
                        <Text
                            text={
                                <span>
                                    Considering the feasibility of the 3
                                    options, we decided to go ahead with the 3rd
                                    one i.e. <b>crowdsourcing</b>.
                                </span>
                            }
                        />
                        <Text
                            bold
                            fontSize="15px"
                            text="How to crowd-source?"
                        />
                        <Text text="Using an anonymous platform to collect data, and use a credit system to maintain sustainability & data flow." />
                        <UnorderedList>
                            <li>
                                Incentivize users to share their location during
                                bus rides & intimate user once you board the
                                bus.
                            </li>
                            <li>
                    ...
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    The First Step towards designing the app was
                                    to define the <b>user story</b>, and
                                    empathically think of the most sustainable
                                    way to get ETA. We thought of <b>busKaro</b>{" "}
                                    & <b>busKarli</b> as two use cases of the
                                    app: -
                                </span>
                            }
                        />
                        <UnorderedList>
                            <li>
                                <b>busKaro</b> (Translation - I want to board
                                the bus) - To reveal ETA for a bus.
                            </li>
                            <li>
                                <b>busKarli</b> (Translation - I have boarded
                                the bus) To earn credits by updating the
                        ...
                        <Text
                            text={
                                <span>
                                    ...
                                    <b>Task Analysis</b> &{" "}
                                    <b>Think Aloud Testing</b> conducted with
                                    15+ subjects, we narrowed down the following
                                    problem areas in our app: -
                                </span>
                            }
                        />
                        <UnorderedList>
                            ...
                            <li>
                                Lack of any option to save favorite routes for
                                frequent bus travelers
                            </li>
                            <li>
                                Difficult to fetch ETAs(busKaro) & Board Bus
                                (busKarli)
                            </li>
                        </UnorderedList>
                        <Text
                            bold
                            fontSize="15px"
                            text="Low Fidelity Prototype II"
                        />
                    </TextContainer>
                    <CarouselContainer>
                        <Carousel
                        ...
                        >
                            <CarouselItem>
                                <Image
                                    src="/buskaro/lofi2_1.png"
                                    alt="lofi2_1"
                                />
                            </CarouselItem>
                            <CarouselItem>
                                <Image
                                    src="/buskaro/lofi2_2.png"
                                    alt="lofi2_2"
                                />
                            </CarouselItem>
                            <CarouselItem>
                                <Image
                                    src="/buskaro/lofi2_3.png"
                                    alt="lofi2_3"
                                />
                            </CarouselItem>
                            <CarouselItem>
                ...
                <FullWidthContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    A fully functional high fidelity prototype
                                    of our app -&gt;{" "}
                                    <b>
                                        <a
                                            style={{
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            bold
                            fontSize="15px"
                            text="High Fidelity Prototype  II"
                        />
                    </TextContainer>
                    ...
                    <TextContainer>
                        <Text
                            text={
                                <span>
                                    We were now ready for the final development
                                    of the app. We used <b>Android Studio</b>{" "}
                                    for the same.
                                </span>
                            }
                        />
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    We started our search for a color scheme by
                                    exploring the website awwwards.com for
                                    award-winning interfaces. We also used the
