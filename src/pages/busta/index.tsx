            ...
            <PageContent>
                ...
                <ContentContainer>
                    ...
                    <ImageContainer aspectRatio="2.14">
                        <Image
                            src="/busta/problems.webp"
                            alt="bus conductor problems"
                        />
                    </ImageContainer>
                    <ImageContainer aspectRatio="3">
                        <Image
                            src="/busta/problems2.webp"
                            alt="bus conductor problems 2"
                        />
                    </ImageContainer>
                    <TextContainer>
