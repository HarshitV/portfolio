            ...
            <PageContent>
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    This project was done as part of the Mobile
                                    Computing course at{" "}
                                    <a href="https://www.iiitd.ac.in/">
                                        IIIT-Delhi
                                    </a>
                                    . The team consisted of 5 students.
                                </span>
                            }
                        />
                        <Heading text="Idea" />
                        <UnorderedList>
                            <li>
                                To have a platform for students of a particular
                                course to upload their class notes.
                            </li>
                            <li>
                                This will make it easier to access their notes
                                anytime, anywhere.
                            </li>
                            <li>
                                It will also help solve the problems where
                                students ask each other for combined notes of
                                the entire semester just before the exam.
                            </li>
                        </UnorderedList>
                    </TextContainer>
                </ContentContainer>
                    ...
                    <>
                        ...
                        <TextContainer>
                            <Text
                                text={
                                    <span>
                                        During our testing, we provided users
                                        with different versions of the app with
                                        different color schemes carefully
                                        selected from{" "}
                                        <a href="https://material.io/">
                                            material.io
                                        </a>
                                        . Based on the feedback received, we
                                        finalized the primary and secondary
                                        color combination as #212254 and #fe6443
                                        respectively.
                                    </span>
                                }
                            />
                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <UnorderedList>
                            <li>
                                Download/Upload notes with just a few clicks.
                            </li>
                    ...
                    <TextContainer>
                        <Text
                            ...
                            text={
                                <span>
                                    Download the app{" "}
                                    <a href="https://bit.ly/instanotes">here</a>
                                    .
                                </span>
                            }
                        />
