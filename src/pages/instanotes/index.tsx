                ...
                <ContentContainer>
                    <TextContainer>
                        ...
                        <Text
                            text={
                                <span>
                                    This project was done as part of the Mobile Computing course at{" "}
                                    <a href='https://www.iiitd.ac.in/'>IIIT-Delhi</a>. The team
                        ...
                        <UnorderedList>
                            ...
                            <li>
                                This will make it easier to access their notes anytime, anywhere.
                            </li>
                            <li>
                                It will also help solve the problems where students ask each other
                                for combined notes of the entire semester just before the exam.
                            </li>
                        </UnorderedList>
                    </TextContainer>
                </ContentContainer>
